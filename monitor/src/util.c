...
#define __CHERI_CAP_PERMISSION_EXECUTE__ 131072
#define __CHERI_CAP_PERMISSION_LOAD_MUTABLE__ 2
#define __CHERI_CAP_PERMISSION_READ__ 262144
...
#define __CHERI_CAP_PERMISSION_WRITE__ 1
...
void putchericap(seL4_TCB_CheriReadRegister_t cap) {
  ...
  struct CheriCapMeta cheri_meta = (struct CheriCapMeta) {.words[0] = cap.cheri_meta};
	...
	/* Attributes */
	const cheri_otype_t type = CheriCapMeta_get_CT(cheri_meta);
#if defined(__riscv)
  ...
  if (perms & __CHERI_CAP_PERMISSION_LOAD_MUTABLE__) {
    *--z = 'M';
	...
	char perms_char_rep[] = {
		...
		'C',
#endif
#ifndef __CHERI_CAP_PERMISSION_CAPABILITY__
		'W', 'R',
#endif
    'x', 'w', 'r'};
